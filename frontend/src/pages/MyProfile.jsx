    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
        ...
        <div>
            ...
            <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
                ...
                <p className='text-purple-400'>{userData.email}</p>
...
<div>
    ...
    <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
        ...
        {
            isEdit ? 
           <select className='max-w-24 bg-gray-100' onChange={(e)=>setUserData(prev=>({...prev,gender:e.target.value}))} value={userData.gender}>
...
<div className='mt-10'>
    {
        isEdit?
        <button className='border border-purple-800 px-8 py-2 rounded-full cursor-pointer hover:bg-purple-800 hover:text-white transition-all' onClick={updateUserProfileData}>Save Information</button>
        :
        <button className='border border-purple-800 px-8 py-2 rounded-full cursor-pointer hover:bg-purple-800 hover:text-white transition-all' onClick={()=>setIsEdit(true)}>Edit</button>
    }
</div>
    </div>
  )
